// ==UserScript==
// @name         krunker mod menu 1.7.1✅fade b1✅V 1.9.2
// @description  A Krunker.io Hack Script (Aimbot, ESP, And More!) by kirua sato
// @version      1.7.2
// @author       kirua sato
...
const cStruct = (...keys) => ((...v) => keys.reduce((o, k, i) => {
        ...
        class Utilities {
            ...
            onLoad() {
                this.newFeature('Resete Menu', "ctrl+suppr", ['', '']);
                ...
                this.newFeature('(VIP)Server Crasher', '7', ['Off','Disconnect','Disconnect Others','Server Dumper']);
                this.newFeature('fake lag 2',"8",['Off', 'On']);
